...
routes.post(
  ...
  auth,
  validationPsicologo,
  psicologosControler.cadastrarPsicologo
);
...
routes.put(
  ...
  validationPsicologo,
  validadorDeId,
  psicologosControler.atualizarPsicologo
);

routes.delete(
  "/psicologo/:id",
  validadorDeId,
  psicologosControler.deletarPsicologo
);
...
routes.post(
  ...
  auth,
  validationPaciente,
  pacientesController.cadastrarPacientes
);
routes.delete(
  "/pacientes/:id",
  validadorDeId,
  pacientesController.deletarPacientes
);
routes.put(
  "/pacientes/:id",
  validadorDeId,
  pacientesController.atualizarPacientes
);
...
routes.get(
  "/dashboards/media-atendimentos",
  dashboardController.mediaAtendimentos
);
